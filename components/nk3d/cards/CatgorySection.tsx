...
export function CategorySection({ category, index }: { category: CategoryGroup; index: number }) {
  ...
  return (
    <div className="border-b border-border">
      ...
      {open && (
        <div className="grid grid-cols-[repeat(auto-fill,minmax(280px,1fr))] gap-2.5 pb-7">
