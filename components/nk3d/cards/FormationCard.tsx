  ...
  const inner = (
    <div className="h-full rounded-xl p-4 px-5 flex items-start justify-between gap-4 border bg-white border-border shadow-[0_1px_4px_rgba(10,45,92,0.05)] transition hover:border-orange/40 hover:shadow-[0_4px_16px_rgba(232,118,42,0.1)]">
      <div className="flex-1">
        <div className="font-eurostile-extended text-[13px] font-bold text-orange tracking-widest uppercase mb-1">
          {formation.code}
        </div>
        ...
        {formation.categorieLabel && (
          <div className="font-montserrat text-base text-text-lt mt-1">
            {formation.categorieLabel}
          </div>
        )}
      </div>
      ...
      <div className="flex items-center gap-2 shrink-0">
        {formation.days && (
          <div className="flex items-center gap-1 bg-orange-lt border border-orange/30 rounded-full py-1 px-2.5 text-orange font-montserrat text-base font-semibold">
